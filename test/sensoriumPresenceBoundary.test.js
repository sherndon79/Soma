...
test("depth presence boundary is unavailable until helper-side derivation exists", () => {
  ...
  assert.equal(plan.blocker, "helper_side_presence_derivation_not_implemented");
