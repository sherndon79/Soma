...
function createHistoryProjectionEvent({ eventType, entry, actor = "", timestamp = "" }) {
  return {
    ...
    structural_risk_class: entry.structural_risk_class,
    structural_acknowledgement_required: entry.structural_acknowledgement_required,
    structural_acknowledgement_decision: entry.structural_acknowledgement_decision,
    structural_acknowledged_by: entry.structural_acknowledged_by,
    structural_acknowledged_at: entry.structural_acknowledged_at,
    non_publication_reason_class: entry.non_publication_reason_class,
